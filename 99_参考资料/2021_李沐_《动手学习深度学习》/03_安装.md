...
- 第三步，安装深度学习框架和`d2l`软件包
  ...
  - 也可以访问官网 ***https://pytorch.org/get-started/locally/*** 选择适合自己电脑 pytorch 版本下载![03-01](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/book/DeepLearning-MuLi-Notes/imgs/02/03-01.png)
