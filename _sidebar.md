  ...
  - [6 神经网络](/神经网络/README.md)
    - [6.1 丢弃法](/神经网络/丢弃法.md)
    - [6.2 多层神经网络](/神经网络/多层神经网络.md)
    - [6.3 损失函数](/神经网络/损失函数/README.md)
      
    - [6.4 正向传播与反向传播](/神经网络/正向传播与反向传播.md)
    - [6.5 激活函数](/神经网络/激活函数/README.md)
      - [6.5.1 ReLU](/神经网络/激活函数/ReLU.md)
      - [6.5.2 sigmoid](/神经网络/激活函数/sigmoid.md)
      - [6.5.3 tanh](/神经网络/激活函数/tanh.md)
    - [6.6 神经网络可视化](/神经网络/神经网络可视化.md)
